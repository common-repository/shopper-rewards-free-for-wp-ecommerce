 ...
 */
class Shopper_Rewards_Details_List_Table extends WP_List_Table {
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'Points',     //singular name of the listed records
            'plural'    => 'Points',    //plural name of the listed records
    ...
    function column_email($item){
        ...
        //Build row actions
        $actions = array(
            'delete'    => sprintf('<a href="?page=%s&action=%s&id=%s">'.__( 'Delete', PBCIBP ) . '</a>',$_REQUEST['page'],'delete',$item['ID']),
        );

        //Return the email column contents
        return sprintf('%1$s <br><span style="color:silver">%2$s</span>%3$s',
            /*$1%s*/ pbci_format_email( $item['email'] ),
            /*$2%s*/ $item['type'],
    ...
    function get_columns(){
        $columns = array(
            ...
            'description'     => __( 'Description', PBCIBP ),
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'purchase_log_id' => array('purchase_log_id',false),
    ...
    function process_bulk_action() {
        ...
        if( 'delete'===$this->current_action() ) {
        	global $wpdb;
            $result = $wpdb->delete( pbci_shopper_rewards_table_name(), array( 'ID' => $_REQUEST['id']) );
            if ( $result == 1 ) {
            	pbci_buyer_show_notice( __( 'Deleted record id ', PBCIBP ) . $_REQUEST['id'] );
            } else {
            	pbci_buyer_show_error( __( 'Could not delete record id ', PBCIBP ) . $_REQUEST['id'] );
            }
        }
    ...
    function prepare_items() {
        ...
        */
        ...
        $sql = "SELECT * FROM `" . pbci_shopper_rewards_table_name() . "` {$where} ORDER BY {$orderby} {$order} {$limit} ";
...
function points_details_list_page(){

    //Create an instance of our package class...
    $points_list_table = new Shopper_Rewards_Details_List_Table();
    ...
    <div class="wrap">
    	...
    	<?php pbci_shopper_rewards_title_box( 'Rewards Points Details' ); ?>
